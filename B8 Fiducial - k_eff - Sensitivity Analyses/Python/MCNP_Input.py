...
class MCNP_File:
    ...
    def __init__(self,
        ...
        """
        self.template_filepath = f"./Python/b8.template"
        ...
        self.parameters = {'datetime': self.datetime,
                           ...
                           'n_per_cycle': N_PER_CYCLE, # 20k for testing, 200k for production
        ...
        if self.print_input:
            with open(self.template_filepath, 'r') as template_file:
                ...
                print(f"  | comment. mcnp input created at: {self.input_filepath}")
        ...
        if not self.mcnp_skipped:
            for extension in output_types_to_move:
                try:
                    ...
                    if extension == ['.o']:
                       os.rename(filename, self.output_filename) 
